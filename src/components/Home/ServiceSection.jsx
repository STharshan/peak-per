...
You’re a Busy Person — don’t let vehicle problems get in your way. `,
  ...
  {
    title: "DPF CLEANING SPECIALIST",
    desc: `For a long time the word DPF has been synonymous with every diesel drivers worst nightmare... 
NOT ANY MORE!!! `,
    image: "/s4.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[95%] mt-10 mx-auto h-55 object-cover"
                    onError={(e) => {
